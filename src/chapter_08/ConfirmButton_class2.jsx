...
class ConfirmButton extends React.Component {
  constructor(props) { // 클래스 컴포넌트에는 요 생성자 함수가 존재함 . 이안에 state 정의
    ...
    // step1 확인 여부를 확인하기 위한 state변수
    this.state = {isConfirmed : false}; // state 정의 - 함수형 컴포넌트에서는 setState사용 

    this.handleConfirm = this.handleConfirm.bind(this); // callback 에서 this를 사용하기 위해서는 바인딩을 필수적으로 해줘야 합니다.
  }
